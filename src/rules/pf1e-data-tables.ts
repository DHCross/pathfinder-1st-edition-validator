...
/**
 * Experience Point Awards by CR
 * Source: Pathfinder 1e Core Rulebook / Gamemastering
 * Covers the standard progression from CR 1/8 to CR 30.
 * Rule: XP doubles every 2 CRs (e.g., CR 10 = 9,600 -> CR 12 = 19,200).
 */
